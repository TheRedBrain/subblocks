...
public class ThreeWayEdgeBlock extends AbstractSubBlock {

    public static DirectionProperty FACING;
    public static final EnumProperty<BlockHalf> HALF;
    // part shapes
    protected static final VoxelShape NORTH_EAST_EDGE_SHAPE;
    protected static final VoxelShape NORTH_WEST_EDGE_SHAPE;
    protected static final VoxelShape SOUTH_EAST_EDGE_SHAPE;
    protected static final VoxelShape SOUTH_WEST_EDGE_SHAPE;
    ...
    public ThreeWayEdgeBlock(BlockState baseBlockState, Settings settings) {
    ...
    static {
        ...
        NORTH_EAST_EDGE_SHAPE = Block.createCuboidShape(8.0D, 0.0D, 0.0D, 16.0D, 16.0D, 8.0D);
        NORTH_WEST_EDGE_SHAPE = Block.createCuboidShape(0.0D, 0.0D, 0.0D, 8.0D, 16.0D, 8.0D);
        SOUTH_EAST_EDGE_SHAPE = Block.createCuboidShape(8.0D, 0.0D, 8.0D, 16.0D, 16.0D, 16.0D);
        SOUTH_WEST_EDGE_SHAPE = Block.createCuboidShape(0.0D, 0.0D, 8.0D, 8.0D, 16.0D, 16.0D);
        ...
        BOTTOM_NORTH_EAST_SHAPE = VoxelShapes.union(NORTH_EAST_EDGE_SHAPE, BOTTOM_SOUTH_EAST_CORNER_SHAPE, BOTTOM_NORTH_WEST_CORNER_SHAPE);
        BOTTOM_NORTH_WEST_SHAPE = VoxelShapes.union(NORTH_WEST_EDGE_SHAPE, BOTTOM_NORTH_EAST_CORNER_SHAPE, BOTTOM_SOUTH_WEST_CORNER_SHAPE);
        BOTTOM_SOUTH_EAST_SHAPE = VoxelShapes.union(SOUTH_EAST_EDGE_SHAPE, BOTTOM_NORTH_EAST_CORNER_SHAPE, BOTTOM_SOUTH_WEST_CORNER_SHAPE);
        BOTTOM_SOUTH_WEST_SHAPE = VoxelShapes.union(SOUTH_WEST_EDGE_SHAPE, BOTTOM_NORTH_WEST_CORNER_SHAPE, BOTTOM_SOUTH_EAST_CORNER_SHAPE);
        TOP_NORTH_EAST_SHAPE = VoxelShapes.union(NORTH_EAST_EDGE_SHAPE, TOP_SOUTH_EAST_CORNER_SHAPE, TOP_NORTH_WEST_CORNER_SHAPE);
        TOP_NORTH_WEST_SHAPE = VoxelShapes.union(NORTH_WEST_EDGE_SHAPE, TOP_NORTH_EAST_CORNER_SHAPE, TOP_SOUTH_WEST_CORNER_SHAPE);
        TOP_SOUTH_EAST_SHAPE = VoxelShapes.union(SOUTH_EAST_EDGE_SHAPE, TOP_NORTH_EAST_CORNER_SHAPE, TOP_SOUTH_WEST_CORNER_SHAPE);
        TOP_SOUTH_WEST_SHAPE = VoxelShapes.union(SOUTH_WEST_EDGE_SHAPE, TOP_NORTH_WEST_CORNER_SHAPE, TOP_SOUTH_EAST_CORNER_SHAPE);
    }
}
